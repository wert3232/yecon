...
import com.tuoxianui.tools.AtTimerHelpr.AtTimerHelprDoItCallBack;
import com.yecon.sound.setting.AudioSetting;
import com.yecon.sound.setting.MyApplication;
import com.yecon.sound.setting.R;
import com.yecon.sound.setting.R.id;
import com.yecon.sound.setting.R.layout;
...
public class EffectSetting extends Activity implements View.OnClickListener,
	...
	Integer ID_RadioButton[] = { R.id.rb_rock, R.id.rb_popu, R.id.rb_live, R.id.rb_dance,
			R.id.rb_classical, R.id.rb_soft, R.id.rb_origin,R.id.rb_jazz,R.id.rb_hiphop, R.id.rb_favourite};
	RadioButton mRadioButton[] = new RadioButton[10];
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(R.layout.activity_tuoxian_effect_setting);
		initData();
		initView();
	}
	...
	private void initData() {
		...
		mmtksetting = new mtksetting(this);
//		mmtksetting.setSharedPreferences(PreferenceManager.getDefaultSharedPreferences(this));
	...
	public void onClick(View arg0) {
		// TODO Auto-generated method stub
		switch (arg0.getId()) {
		case R.id.rb_rock: //摇滚
			setTitleStatus(0);
			break;
		case R.id.rb_popu: //流行
			setTitleStatus(1);
			break;
		case R.id.rb_live: //现场
			setTitleStatus(2);
			break;
		case R.id.rb_dance: //舞曲
			setTitleStatus(3);
			break;
		case R.id.rb_classical: //古典
			setTitleStatus(4);
			break;
		case R.id.rb_soft: //柔和
			setTitleStatus(5);
			break;
		case R.id.rb_origin: //原音标准
			setTitleStatus(6);
			break;
		case R.id.rb_jazz: //爵士
			setTitleStatus(7);
			break;
		case R.id.rb_hiphop: //爵士
			setTitleStatus(8);
			break;
		case R.id.rb_favourite://个性
			setSelfEffect();
			break;
		case R.id.btn_reset:
			setTitleStatus(6);
