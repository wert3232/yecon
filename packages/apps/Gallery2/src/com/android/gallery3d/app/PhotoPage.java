...
public class PhotoPage extends ActivityState implements
    ...
    public void onCreate(Bundle data, Bundle restoreState) {
        ...
        mBroker = new NotifyBroker();
        mApplication.getAndroidContext()
            .registerReceiver(mBroker, filter);
    }
    ...
    protected void onDestroy() {
        ...
        if (mCurrentPhoto instanceof UriImage) {
            UriImage img = (UriImage)mCurrentPhoto;
            if (img != null) {
    ...
    private NotifyBroker mBroker;
    private class NotifyBroker extends BroadcastReceiver {
