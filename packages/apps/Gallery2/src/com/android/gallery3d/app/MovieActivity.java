...
public class MovieActivity extends Activity {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(MCU_ACTION_HEADLIGHTS_AND_BRAKE_STATUS)) {
                ...
                if (mParkingEnable && !mMcuIsParking) {
                    mPlayer.updateParkingLayout(true);
                } else {
                    mPlayer.updateParkingLayout(false);
                }
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "MovieActivity - onCreate");
        ...
        registerReceiver(mParkingListener, filter);
    }
    ...
    public void onResume() {
        ...
        Log.e(TAG, "MovieActivity - onResume - mParkingEnable: " + mParkingEnable
    ...
    public void onDestroy() {
        unregisterReceiver(mParkingListener);
