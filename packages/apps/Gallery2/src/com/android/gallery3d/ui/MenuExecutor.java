...
public class MenuExecutor {
    ...
    private class ConfirmDialogListener implements OnClickListener, OnCancelListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            boolean isAMonkey = ActivityManager.isUserAMonkey();
            boolean isAMonkeyOnDel = isAMonkey && mActionId == R.id.action_delete;
            if ((which == DialogInterface.BUTTON_POSITIVE) && !isAMonkeyOnDel) {
                if (mListener != null) {
