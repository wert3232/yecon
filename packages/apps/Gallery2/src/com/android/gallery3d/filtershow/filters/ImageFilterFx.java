...
public class ImageFilterFx extends ImageFilter {
    ...
    public ImageFilterFx(Bitmap fxBitmap,String name) {
        ...
        if ((null != this.fxBitmap) && (Bitmap.Config.ARGB_8888 != this.fxBitmap.getConfig())) {
            this.fxBitmap = this.fxBitmap.copy(Bitmap.Config.ARGB_8888, false);
        }
    }
    ...
    public Bitmap apply(Bitmap bitmap, float scaleFactor, boolean highQuality) {
        ...
        nativeApplyFilter(applyBitmap, w, h,   fxBitmap,  fxw,  fxh);
