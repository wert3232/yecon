...
//        mMonthSpinner.setBackgroundColor(Color.GREEN);
        // year
    ...
    public void LogViewGroup(ViewGroup group){
        for(int i = 0; i < group.getChildCount() ; i++){
        	View view = group.getChildAt(i);
        	L.e(view.getClass().getName());
        	if(view instanceof ViewGroup){
        		LogViewGroup((ViewGroup) view);
        	}
        	if(view instanceof NumberPicker){
        		if(view.getId() == R.id.year){
        			L.i("log NumberPicker year");
        		}
        		else if(view.getId() == R.id.month){
        			L.i("log NumberPicker month");
        		}
        		else if(view.getId() == R.id.day){
        			L.i("log NumberPicker day");
        		}
        	}
        }
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MyDatePicker.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MyDatePicker.class.getName());
    }
    ...
    private void setCurrentLocale(Locale locale) {
        ...
        for (int i = 0; i < mNumberOfMonths; i++) {
        	...
        	String month = String.format("%02d", 1 + i); 
        	mShortMonths[i] = month;
        }
    }
    ...
    /**
     * sequence year month day 's spinner position
