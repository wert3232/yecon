 ...
 */
public interface IMapCallback extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements nfore.android.bt.servicemanager.IMapCallback
{
private static final java.lang.String DESCRIPTOR = "nfore.android.bt.servicemanager.IMapCallback";
...
/**
 * Cast an IBinder object into an nfore.android.bt.servicemanager.IMapCallback interface,
 * generating a proxy if needed.
 */
public static nfore.android.bt.servicemanager.IMapCallback asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof nfore.android.bt.servicemanager.IMapCallback))) {
return ((nfore.android.bt.servicemanager.IMapCallback)iin);
}
return new nfore.android.bt.servicemanager.IMapCallback.Stub.Proxy(obj);
}
...
private static class Proxy implements nfore.android.bt.servicemanager.IMapCallback
{
