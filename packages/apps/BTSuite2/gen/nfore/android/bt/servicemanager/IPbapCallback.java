 ...
 * @version 1.1
 */
public interface IPbapCallback extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements nfore.android.bt.servicemanager.IPbapCallback
{
private static final java.lang.String DESCRIPTOR = "nfore.android.bt.servicemanager.IPbapCallback";
...
/**
 * Cast an IBinder object into an nfore.android.bt.servicemanager.IPbapCallback interface,
 * generating a proxy if needed.
 */
public static nfore.android.bt.servicemanager.IPbapCallback asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof nfore.android.bt.servicemanager.IPbapCallback))) {
return ((nfore.android.bt.servicemanager.IPbapCallback)iin);
}
return new nfore.android.bt.servicemanager.IPbapCallback.Stub.Proxy(obj);
}
...
private static class Proxy implements nfore.android.bt.servicemanager.IPbapCallback
{
...
/*
	 ...
	 */
@Override public void retPbapDeleteDatabaseByAddressCompleted(java.lang.String adrress, boolean isSuccessed) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(adrress);
_data.writeInt(((isSuccessed)?(1):(0)));
...
/*
	 ...
	 * @param isSuccessed : true if deletion is completed successfully
	 */
public void retPbapDeleteDatabaseByAddressCompleted(java.lang.String adrress, boolean isSuccessed) throws android.os.RemoteException;
/*
	 * Callback to inform response to {@link INforeService#reqPbapCleanDatabase reqPbapCleanDatabase}
	 * when database has been cleaned.
    *
