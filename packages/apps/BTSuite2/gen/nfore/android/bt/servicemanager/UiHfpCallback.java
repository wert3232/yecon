 ...
 */
public interface UiHfpCallback extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements nfore.android.bt.servicemanager.UiHfpCallback
{
private static final java.lang.String DESCRIPTOR = "nfore.android.bt.servicemanager.UiHfpCallback";
...
/**
 * Cast an IBinder object into an nfore.android.bt.servicemanager.UiHfpCallback interface,
 * generating a proxy if needed.
 */
public static nfore.android.bt.servicemanager.UiHfpCallback asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof nfore.android.bt.servicemanager.UiHfpCallback))) {
return ((nfore.android.bt.servicemanager.UiHfpCallback)iin);
}
return new nfore.android.bt.servicemanager.UiHfpCallback.Stub.Proxy(obj);
}
...
case TRANSACTION_onHfpCallStateChanged:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
int _arg2;
_arg2 = data.readInt();
this.onHfpCallStateChanged(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
case TRANSACTION_onHfpMuteStateChanged:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
int _arg2;
_arg2 = data.readInt();
this.onHfpMuteStateChanged(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
case TRANSACTION_onHfpMicSelectionChanged:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
int _arg2;
_arg2 = data.readInt();
this.onHfpMicSelectionChanged(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
}
...
private static class Proxy implements nfore.android.bt.servicemanager.UiHfpCallback
{
...
@Override public void onHfpCallStateChanged(java.lang.String address, int prevState, int newState) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(prevState);
_data.writeInt(newState);
mRemote.transact(Stub.TRANSACTION_onHfpCallStateChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void onHfpMuteStateChanged(java.lang.String address, int prevState, int newState) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(prevState);
_data.writeInt(newState);
mRemote.transact(Stub.TRANSACTION_onHfpMuteStateChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void onHfpMicSelectionChanged(java.lang.String address, int prevState, int newState) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(prevState);
_data.writeInt(newState);
mRemote.transact(Stub.TRANSACTION_onHfpMicSelectionChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_retPbapQueryName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_onHfpActiveNumberChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_onHfpCallStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_onHfpMuteStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_onHfpMicSelectionChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
}
/** 
	 * Callback to inform change in HFP state of remote connected device with given Bluetooth hardware address.
	 * Bluetooth hardware addresses would be in a format such as "00:11:22:33:AA:BB".
...
public void onHfpCallStateChanged(java.lang.String address, int prevState, int newState) throws android.os.RemoteException;
public void onHfpMuteStateChanged(java.lang.String address, int prevState, int newState) throws android.os.RemoteException;
public void onHfpMicSelectionChanged(java.lang.String address, int prevState, int newState) throws android.os.RemoteException;
}
