...
public class VCardEntry {
    ...
    private CallDatetimeData mCallDatetimeData; // added
    ...
    public void addProperty(final VCardProperty property) {
        ...
        if (propertyName.equals(VCardConstants.PROPERTY_X_IRMC_CALL_DATETIME)) { //added
            mCallDatetimeData = new CallDatetimeData(propValue);  
        }
        /*Log.i("callLog","propertyName :" + propertyName +"  "+propValue);*/
