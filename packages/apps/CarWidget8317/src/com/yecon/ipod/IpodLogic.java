...
public class IpodLogic extends WidgetsBase {
	private static final String TAG = "ipodLogic";
	 ...
	 * @param context
	 */
	public void updateIpod(final RemoteViews remoteViews, final Context context) {
		String name = "";
		...
		Log.i(TAG, "widget--->updateIpod, name="+name);
	    
		remoteViews.setTextViewText(R.id.ipod_name, name);
	}
	
	@Override
	public void init(final Context context) {
		// TODO Auto-generated method stub
		Log.i(TAG, "widget--->ipodlogic init");
		
		final RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.ipod_widget_layout);
		...
		remoteViews.setOnClickPendingIntent(R.id.ipod_prev_btn, prePendingIntent);
		...
		remoteViews.setOnClickPendingIntent(R.id.ipod_next_btn, nextPendingIntent);		
		...
		remoteViews.setOnClickPendingIntent(R.id.ipod_playpause_btn, playpausePendingIntent);
		...
		if (ConstDefine.TOUCH_INTO_APP) {
			...
			enterIntent.setComponent(new ComponentName("com.yecon.ipodplayer", "com.yecon.ipodplayer.MainActivity"));
			PendingIntent enterPendingIntent = PendingIntent.getActivity(context, 0, enterIntent, PendingIntent.FLAG_CANCEL_CURRENT);
			remoteViews.setOnClickPendingIntent(R.id.ipod_layout, enterPendingIntent);
		}
		
		updateIpod(remoteViews, context);
	...
	public void notify(final Context context, final String s) {
		// TODO Auto-generated method stub
		Log.d(TAG, "##widget_ipod receive msg="+s);
