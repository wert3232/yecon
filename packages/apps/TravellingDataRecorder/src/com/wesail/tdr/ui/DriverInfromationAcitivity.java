...
public class DriverInfromationAcitivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        intent.addAction(ActionConstants.INFO_DRIVER);
	...
	protected void onResume() {
		...
		intent.putExtra("cmd", new byte[]{(byte)0x01});
	...
	private void initData() {
		mContext = this;
		nameAdapter = new InfromationAdapter(this, R.array.driver_information_list);
		
		List<String> contents = new ArrayList<String>();	
		contents.add("driver_s_license_number");
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(ActionConstants.INFO_DRIVER.equalsIgnoreCase(action)){
				abortBroadcast();
				String driver_s_license_number = intent.getStringExtra("driver_s_license_number");
