...
public class TestWifi {
    ...
    public TestWifi(Context context) {
        mWifiManager = (WifiManager) context.getSystemService(Context.WIFI_SERVICE);
        mWifiInfo = mWifiManager.getConnectionInfo();
        printLog("TestWifi: " + mWifiInfo.toString());
    }
    ...
    public void openWifi() {
        ...
        printLog("openWifi - isWifiEnabled: " + mWifiManager.isWifiEnabled());
    }
    ...
    public void addNetwork(WifiConfiguration wifiConfig) {
        ...
        printLog("addNetwork - wcgID: " + wcgID + " - enable: " + enable);
    }
    ...
    public WifiConfiguration createWifiInfo(String SSID, String Password, int Type) {
        ...
        printLog("createWifiInfo - Type: " + Type);
    ...
    public boolean getWebpage() {
        HttpGet get = new HttpGet(DEFAULT_URL);
