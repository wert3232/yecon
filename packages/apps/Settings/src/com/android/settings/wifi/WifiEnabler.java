...
public class WifiEnabler implements CompoundButton.OnCheckedChangeListener  {
	...
	private String LOG_TAG = "WifiEnabler";
    ...
    private void handleWifiStateChanged(int state) {
        switch (state) {
            case WifiManager.WIFI_STATE_ENABLING:
				Log.e(LOG_TAG,"handleWifiStateChanged: WIFI_STATE_ENABLING");
                mSwitch.setEnabled(false);
                break;
            case WifiManager.WIFI_STATE_ENABLED:
				Log.e(LOG_TAG,"handleWifiStateChanged: WIFI_STATE_ENABLED");
                setSwitchChecked(true);
                mSwitch.setEnabled(true);
                break;
            case WifiManager.WIFI_STATE_DISABLING:
				Log.e(LOG_TAG,"handleWifiStateChanged: WIFI_STATE_DISABLING");
                mSwitch.setEnabled(false);
                break;
            case WifiManager.WIFI_STATE_DISABLED:
				 Log.e(LOG_TAG,"handleWifiStateChanged: WIFI_STATE_DISABLED");
                setSwitchChecked(false);
                mSwitch.setEnabled(true);
                break;
            default:
				Log.e(LOG_TAG,"handleWifiStateChanged: default");
                setSwitchChecked(false);
                mSwitch.setEnabled(true);
                break;
        }
