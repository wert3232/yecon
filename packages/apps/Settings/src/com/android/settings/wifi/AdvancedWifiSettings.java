...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    private void updateSleepPolicySummary(Preference sleepPolicyPref, String value) {
        if (value != null) {
            String[] values = isAdded()?getResources().getStringArray(R.array.wifi_sleep_policy_values):null;
	
	    if(null == values)
	    {
		Log.d(TAG, "----[kuan]AdvancedWifiSettings:updateSleepPlicySummary:values = null");
		return;
	    }
	    ...
	    if(null == getResources()){
	    	Log.d(TAG,"----[kuan]AdvancedWifiSettings:updateSleepPlicySummary:getResources() = null");
		return;
	    }
