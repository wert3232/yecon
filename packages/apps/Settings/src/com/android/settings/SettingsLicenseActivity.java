...
public class SettingsLicenseActivity extends Activity {
    ...
    private class LicenseFileLoader implements Runnable {
		...
		public static final int STATUS_OUTOF_MEMORY = 4;
        ...
        public void run() {
            ...
            try {
                ...
                Log.e(INNER_TAG, "[Lingling]OutOfException Error reading license HTML file at " + mFileName, e);
                status = STATUS_OUTOF_MEMORY;
            } finally {
                try {
                    if (inputReader != null) {
                        inputReader.close();
