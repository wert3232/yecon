...
public class Memory extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        for (StorageVolume volume : storageVolumes) {
            ...
            //Log.i(TAG, "[Lingling]onCreate.0.." + volume.getDescription(context) );
            int revalue_num1 = volume.getDescription(context).indexOf("PART");
			int revalue_num2 = volume.getDescription(context).indexOf("UDISK3");
			int revalue_num3 = volume.getDescription(context).indexOf("UDISK4");
			int revalue_num4 = volume.getDescription(context).indexOf("UDISK5");
			if((revalue_num1==-1)&&(revalue_num2==-1)&&(revalue_num3==-1)&&(revalue_num4==-1))
            	addCategory(StorageVolumePreferenceCategory.buildForPhysical(context, volume));
        }
    ...
    public void onPrepareOptionsMenu(Menu menu) {
		...
		if(usb!=null)
			...
			Log.e(TAG, "[Lingling]Memory:onPrepareOptionsMenu:usb==null||isMassStorageEnabled()==null");
		}
        //usb.setVisible(!isMassStorageEnabled());
    }
    ...
    public static class ConfirmClearCacheFragment extends DialogFragment {
	    ...
	    FragmentManager fm = parent.getFragmentManager();
            if (fm.findFragmentByTag("TAG_CONFIRM_CLEAR_CACHE") == null) {
				Log.d(TAG, "[Lingling]Memory:ConfirmClearCacheFragment");
			}else
