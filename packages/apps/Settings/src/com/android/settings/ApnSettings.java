...
public class ApnSettings extends PreferenceActivity implements
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mAPN_new = (Preference) findPreference("apn_new");
        mAPN_new.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
    ...
    private void fillList() {
        ...
        //apnList.removeAll();
        for (int num = apnList.getPreferenceCount();num > 1;num--) {
            apnList.removePreference(apnList.getPreference(num-1));
        }
