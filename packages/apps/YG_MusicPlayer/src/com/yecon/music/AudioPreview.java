...
{
    public final static String ACTION_QB_POWERON = "autochips.intent.action.QB_POWERON";
    public final static String ACTION_QB_POWEROFF = "autochips.intent.action.QB_POWEROFF";
    ...
    void initReceiver() {
        ...
        registerReceiver(mDiskListener, new IntentFilter(filter));
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(ACTION_QB_POWERON)) {
                AudioPreview.this.finish();
            		   ...
            		   action.equals(ACTION_QB_PREPOWEROFF)) {
                if (mPlayer != null) {
                    mPlayer.release();
                    mPlayer = null;
                }
    ...
    private void stopPlayback() {
        ...
        if (mPlayer != null) {
            ...
            L.e(TAG, "stopPlayback:abandonAudioFocus");
        }
    }
    ...
    private OnAudioFocusChangeListener mAudioFocusListener = new OnAudioFocusChangeListener() {
        public void onAudioFocusChange(int focusChange) {
        	L.e(TAG, "mAudioFocusListener:" + focusChange);
            if (mPlayer == null) {
                ...
                L.e(TAG, "mAudioFocusListener:abandonAudioFocus");
                return;
            }
            switch (focusChange) {
