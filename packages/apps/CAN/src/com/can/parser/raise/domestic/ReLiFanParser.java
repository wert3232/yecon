...
/**
 * ClassName:ReLiFanParser
 * 
 * @function:力帆解析器
 * @author Kim
 * @Date:  2016-7-23下午12:01:18
 * @Copyright: Copyright (c) 2016
 * @version 1.0
 */
public class ReLiFanParser extends CanProxy{

	private Handler mObjHandler;
	private ReLiFanProtocol mObjProtocol;
	...
	public void start(Handler handler, Context context, String name,
		...
		this.mObjProtocol = (ReLiFanProtocol) protocol;
	}

	@Override
	public void Init(E_CMD_TYPE eCmdType) {
		// TODO Auto-generated method stub
		super.RegisterProxy(ReLiFanProtocol.DATA_TYPE_AIR_INFO,
				ReLiFanProtocol.DATA_TYPE_AIR_INFO);
		super.RegisterProxy(ReLiFanProtocol.DATA_TYPE_BASE_INFO,
				ReLiFanProtocol.DATA_TYPE_BASE_INFO);
		super.RegisterProxy(ReLiFanProtocol.DATA_TYPE_WHEEL_KEY_INFO,
				ReLiFanProtocol.DATA_TYPE_WHEEL_KEY_INFO);
		super.RegisterProxy(ReLiFanProtocol.DATA_TYPE_RADAR_INFO,
				ReLiFanProtocol.DATA_TYPE_RADAR_INFO);
		super.RegisterProxy(ReLiFanProtocol.DATA_TYPE_WHEEL_INFO,
				ReLiFanProtocol.DATA_TYPE_WHEEL_INFO);
		super.RegisterProxy(ReLiFanProtocol.DATA_TYPE_PANEL_KEY_INFO,
				ReLiFanProtocol.DATA_TYPE_PANEL_KEY_INFO);
	}
	...
	public void handleMessage(Message msg) {
		...
		case CanTxRxStub.MSG_CAN_RX:
			...
			if (iCmdID == mObjProtocol.GetAirInfoCmdId()) {
				...
				mObjHandler.sendMessage(objUImsg);
			} else if (iCmdID == mObjProtocol.GetRadarCmdId()) {
