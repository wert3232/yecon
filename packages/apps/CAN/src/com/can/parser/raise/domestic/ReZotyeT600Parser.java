...
/**
 * ClassName:ReZotyeT600Parser
 * 
 * @function:众泰T600解析器
 * @author Kim
 * @Date:  2016-7-23上午11:17:18
 * @Copyright: Copyright (c) 2016
 * @version 1.0
 */
public class ReZotyeT600Parser extends CanProxy{

	private Handler mObjHandler;
	private ReZotyeT600Protocol mObjProtocol;
	...
	public void start(Handler handler, Context context, String name,
		...
		this.mObjProtocol = (ReZotyeT600Protocol) protocol;
	}

	@Override
	public void Init(E_CMD_TYPE eCmdType) {
		// TODO Auto-generated method stub
		super.RegisterProxy(ReZotyeT600Protocol.DATA_TYPE_AIR_INFO,
				ReZotyeT600Protocol.DATA_TYPE_AIR_INFO);
		super.RegisterProxy(ReZotyeT600Protocol.DATA_TYPE_TPMS_INFO,
				ReZotyeT600Protocol.DATA_TYPE_TPMS_INFO);
		super.RegisterProxy(ReZotyeT600Protocol.DATA_TYPE_BASE_INFO,
				ReZotyeT600Protocol.DATA_TYPE_BASE_INFO);
		super.RegisterProxy(ReZotyeT600Protocol.DATA_TYPE_WHEEL_KEY_INFO,
				ReZotyeT600Protocol.DATA_TYPE_WHEEL_KEY_INFO);
		super.RegisterProxy(ReZotyeT600Protocol.DATA_TYPE_TPMS_WARN,
				ReZotyeT600Protocol.DATA_TYPE_TPMS_WARN);
	}
