...
public final class Launcher extends Activity
    ...
    // adb shell setprop L.tag.PROPERTY_NAME [VERBOSE | SUPPRESS]
    ...
    protected void onActivityResult(
        ...
        if (isWidgetDrop) {
            int appWidgetId = data != null ?
                    data.getIntExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, -1) : -1;
            if (appWidgetId < 0) {
            	L.e(TAG, "Error: appWidgetId (EXTRA_APPWIDGET_ID) was not returned from the \\" +
    ...
    protected void onResume() {
        ...
        //���ʹ�����ʶ��Ĺ㲥
        Intent voiceIntent = new Intent("com.yecon.action.openvoice");
        ...
        if (hasFocus) {
            ...
            inputManager.hideSoftInputFromWindow(lp.token, 0, new android.os.ResultReceiver(new
                        ...
                        protected void onReceiveResult(int resultCode, Bundle resultData) {
                            L.d(TAG, "ResultReceiver got resultCode=" + resultCode);
                        }
                    });
            L.d(TAG, "called hideSoftInputFromWindow from onWindowFocusChanged");
        }
    }
    */
...
//        return handled;
    ...
    void completeAddApplication(Intent data, long container, int screen, int cellX, int cellY) {
        ...
        if (info != null) {
            ...
            L.e(TAG, "Couldn't find ActivityInfo for selected application: " + data);
        }
    }
    ...
    public void onDestroy() {
        ...
        try {
            ...
            L.w(TAG, "problem while stopping AppWidgetHost during Launcher destruction", ex);
        }
        mAppWidgetHost = null;
...
//        }
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		//myHandler.removeMessages(Utils.HANDLER_ID_CALIBRATION);
		if(pointCount >= 5)
		{
			sendMessage(Utils.HANDLER_ID_CALIBRATION);
		}
		
		L.i("lzy", ".......................pointCount........." + pointCount);
	...
	public void sendMessage(int what) {
		...
		message.what = what;
		myHandler.sendMessageDelayed(message, Utils.DELAYMILLIS_CALIBRATION);
	}

	Handler myHandler = new Handler() {
		public void handleMessage(Message msg) {
			if (Utils.HANDLER_ID_CALIBRATION == msg.what) {
    ...
    boolean startActivity(View v, Intent intent, Object tag) {
        ...
        try {
            ...
            //����� CARLIFE���͹ر�����ʶ��Ĺ㲥
            if (tag != null) {
            	String packagename = ((ShortcutInfo)tag).componentName.getPackageName();
                if (packagename != null) {
                	if (packagename.equals("com.baidu.carlifevehicle")) {
            ...
            L.e(TAG, "Launcher does not have the permission to launch " + intent +
    ...
    boolean startActivitySafely(View v, Intent intent, Object tag) {
        ...
        try {
            ...
            Toast.makeText(this, R.string.activity_not_found, Toast.LENGTH_SHORT).show();
            L.e(TAG, "Unable to launch. tag=" + tag + " intent=" + intent, e);
        }
        return success;
    }
    ...
    private void handleFolderClick(FolderIcon folderIcon) {
        ...
        if (info.opened && openFolder == null) {
            L.d(TAG, "Folder info marked as open, but associated folder is not open. Screen: "
    ...
    public void openFolder(FolderIcon folderIcon) {
        ...
        if (folder.getParent() == null) {
            ...
            L.w(TAG, "Opening folder (" + folder + ") which already has a parent (" +
                    folder.getParent() + ").");
        }
        folder.animateOpen();
    ...
    private Drawable getExternalPackageToolbarIcon(ComponentName activityName, String resourceName) {
        try {
            ...
            L.w(TAG, "Failed to load toolbar icon; " + activityName.flattenToShortString() +
                    " not found", e);
        } catch (Resources.NotFoundException nfe) {
            // This can happen if the activity defines an invalid drawable
            L.w(TAG, "Failed to load toolbar icon from " + activityName.flattenToShortString(),
                    nfe);
        }
        return null;
    }
    ...
    public void bindAppWidget(LauncherAppWidgetInfo item) {
        ...
        if (DEBUG_WIDGETS) {
            L.d(TAG, "bindAppWidget: id=" + item.appWidgetId + " belongs to component " + appWidgetInfo.provider);
        }
        ...
        if (DEBUG_WIDGETS) {
            L.d(TAG, "bound widget id="+item.appWidgetId+" in "
    ...
    public void dumpState() {
        ...
        L.d(TAG, "mSavedState=" + mSavedState);
        L.d(TAG, "mWorkspaceLoading=" + mWorkspaceLoading);
        L.d(TAG, "mRestoring=" + mRestoring);
        L.d(TAG, "mWaitingForResult=" + mWaitingForResult);
        L.d(TAG, "mSavedInstanceState=" + mSavedInstanceState);
