...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    public static class FolderRingAnimator {
        ...
        public static int sAppIconSize = -1;
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            if (sStaticValuesDirty) {
                ...
                sAppIconSize = (int)res.getDimension(R.dimen.app_icon_size);
    ...
    private int mIntrinsicIconGap = -1;
    private int mIntrinsicIconAvailableSpace = -1;
    private float mIntrinsicIconScale = 0.22f;
    ...
    private void computePreviewDrawingParams(int drawableSize, int totalSize) {
        if (mIntrinsicIconSize != drawableSize || mTotalWidth != totalSize) {
            ...
            //
            mIntrinsicIconAvailableSpace = (int) (FolderRingAnimator.sAppIconSize - 5 - 2 * previewPadding);
            mSmallIconSize = (int)(FolderRingAnimator.sAppIconSize * mIntrinsicIconScale);
            mIntrinsicIconGap = (mIntrinsicIconAvailableSpace - 3 * mSmallIconSize) / 2;
            //
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
    	...
    	if (index > NUM_ITEMS_IN_PREVIEW -1 ) {
    		index = 4;
		}
    	//float scale = 0.30f;
        //final int previewPadding = 1;
        //float offset = mAvailableSpaceInPreview /3;
        //final int overlayAlpha = 0;
        //float transY = previewPadding + (index / 3) * offset;
        //float transX = 	previewPadding + (index % 3) * offset;
    	
    	float scale = mIntrinsicIconScale;
    	final int previewPadding = FolderRingAnimator.sPreviewPadding;
        final int overlayAlpha = 0;
    	float transX = previewPadding + (mSmallIconSize + mIntrinsicIconGap) * (index % 3);
        float transY = previewPadding + (mSmallIconSize + mIntrinsicIconGap) * (index / 3);
        if (params == null) {
