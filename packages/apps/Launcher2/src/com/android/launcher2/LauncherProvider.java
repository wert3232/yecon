...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            if (LOGD) L.d(TAG, "creating new launcher database");
        ...
        private boolean convertDatabase(SQLiteDatabase db) {
            if (LOGD) L.d(TAG, "converting database from an older format, but not onUpgrade");
            ...
            if (converted) {
                ...
                if (LOGD) L.d(TAG, "converted and now triggering widget upgrade");
                convertWidgets(db);
            }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            if (LOGD) L.d(TAG, "onUpgrade triggered");
            ...
            if (version != DATABASE_VERSION) {
                L.w(TAG, "Destroying all old data.");
        ...
        private boolean updateContactsShortcuts(SQLiteDatabase db) {
            ...
            try {
                ...
                if (LOGD) L.d(TAG, "found upgrade cursor count=" + c.getCount());
                ...
                while (c.moveToNext()) {
                    ...
                    if (intentUri != null) {
                        try {
                            ...
                            L.e(TAG, "Problem upgrading shortcut", ex);
                        } catch (URISyntaxException e) {
                            L.e(TAG, "Problem upgrading shortcut", e);
                        }
                    }
                }
                ...
                L.w(TAG, "Problem while upgrading contacts", ex);
                return false;
            } finally {
                db.endTransaction();
                if (c != null) {
            ...
            try {
                ...
                while (c.moveToNext()) {
                    ...
                    try {
                        ...
                        if (!logged) {
                            L.e(TAG, "Failed normalizing icon " + id, e);
                        } else {
                            L.e(TAG, "Also failed normalizing icon " + id);
                        }
                        logged = true;
                    }
                }
                ...
                L.w(TAG, "Problem while allocating appWidgetIds for existing widgets", ex);
            } finally {
                db.endTransaction();
                if (update != null) {
                    update.close();
            ...
            try {
                ...
                while (c != null && c.moveToNext()) {
                    ...
                    try {
                        ...
                        if (LOGD) {
                            L.d(TAG, "allocated appWidgetId=" + appWidgetId
                        ...
                        L.e(TAG, "Problem allocating appWidgetId", ex);
                    }
                }
        ...
        private int loadFavorites(SQLiteDatabase db, int workspaceResourceId) {
            ...
            try {
                ...
                L.w(TAG, "Got exception parsing favorites.", e);
            } catch (IOException e) {
                L.w(TAG, "Got exception parsing favorites.", e);
        ...
        private long addAppShortcut(SQLiteDatabase db, ContentValues values, TypedArray a,
            ...
            try {
                ...
                L.w(TAG, "Unable to add favorite: " + packageName +
                        "/" + className, e);
            }
            return id;
        }
        ...
        private long addUriShortcut(SQLiteDatabase db, ContentValues values,
            ...
            try {
                ...
                L.w(TAG, "Shortcut has malformed uri: " + uri);
                return -1; // Oh well
            }

            if (iconResId == 0 || titleResId == 0) {
                L.w(TAG, "Shortcut is missing title or icon resource ID");
                return -1;
            }
