...
static int
android_media_AudioSystem_setCustomStreamVolumeIndex(JNIEnv *env,
                                               jobject thiz,
                                               jint stream,
                                               jint index,
                                               jint volumeData,
                                               jint device)
{
    ALOGI("android_media_AudioSystem_setCustomStreamVolumeIndex - setvolume");
    return check_AudioSystem_Command(
            AudioSystem::setCustomStreamVolumeIndex(static_cast <audio_stream_type_t>(stream),
                                              index,
                                              volumeData,
                                              (audio_devices_t)device));
}
...
static jboolean
android_media_AudioSystem_setAudPolicyPriority(JNIEnv *env,
                                               jobject thiz,
                                               jint stream,
                                               jint Priority)
{
    return AudioSystem::setAudPolicyPriority(stream, Priority);
}

static jboolean
android_media_AudioSystem_setAudPolicyStrategy(JNIEnv *env,
                                               jobject thiz,
                                               jint stream1,
                                               jint stream2,
                                               jint Strategy)
{
    return AudioSystem::setAudPolicyStrategy(stream1, stream2, Strategy);
}



static int
android_media_AudioSystem_setAudHWVolMax(JNIEnv *env,
                                         jobject thiz,
                                         jint value)
{
    return check_AudioSystem_Command(AudioSystem::setAudHWVolMax(value));
}
...
static JNINativeMethod gMethods[] = {
    ...
    {"setCustomStreamVolumeIndex","(IIII)I",   (void *)android_media_AudioSystem_setCustomStreamVolumeIndex},
    {"setAudPolicyPriority","(II)Z",    (void *)android_media_AudioSystem_setAudPolicyPriority},
    {"setAudPolicyStrategy","(III)Z",   (void *)android_media_AudioSystem_setAudPolicyStrategy},
    {"setAudHWVolMax",      "(I)I",     (void *)android_media_AudioSystem_setAudHWVolMax},    
