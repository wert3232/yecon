...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    /** Key code constant: Yecon eq key. */
    public static final int KEYCODE_YECON_EQ                = 220;
    /** Key code constant: Yecon bt phone on key. */
    public static final int KEYCODE_YECON_PHONE_ON          = 221;
    /** Key code constant: Yecon bt phone off key. */
    public static final int KEYCODE_YECON_PHONE_OFF         = 222;
    /** Key code constant: Yecon source mode key. */
    public static final int KEYCODE_YECON_SOURCE_MODE       = 223;
    /** Key code constant: Yecon home frontsrc key. */
    public static final int KEYCODE_YECON_HOME_FRONTSRC     = 224;
    /** Key code constant: Yecon dvd eject key. */
    public static final int KEYCODE_YECON_DVD_EJECT         = 225;
    /** Key code constant: Yecon dvd close key. */
    public static final int KEYCODE_YECON_DVD_CLOSE         = 226;
    /** Key code constant: Yecon music key. */
    public static final int KEYCODE_YECON_MUSIC             = 227;
    /** Key code constant: Yecon photo key. */
    public static final int KEYCODE_YECON_PHOTO             = 228;
    /** Key code constant: Yecon video key. */
    public static final int KEYCODE_YECON_VIDEO             = 229;
    /** Key code constant: Yecon navi key. */
    public static final int KEYCODE_YECON_NAVI              = 230;
    /** Key code constant: Yecon tuner key. */
    public static final int KEYCODE_YECON_TUNER             = 231;
    /** Key code constant: Yecon dvd key. */
    public static final int KEYCODE_YECON_DVD               = 232;
    /** Key code constant: Yecon bluetooth key. */
    public static final int KEYCODE_YECON_BLUETOOTH         = 233;
    /** Key code constant: Yecon setting key. */
    public static final int KEYCODE_YECON_SETTING           = 234;
    /** Key code constant: Yecon tv key. */
    public static final int KEYCODE_YECON_TV                = 235;
    /** Key code constant: Yecon usb key. */
    public static final int KEYCODE_YECON_USB               = 236;
    /** Key code constant: Yecon sd card key. */
    public static final int KEYCODE_YECON_SD_CARD           = 237;
    /** Key code constant: Yecon touch menu key. */
    public static final int KEYCODE_YECON_TOUCH_MENU        = 238;
    /** Key code constant: Yecon play key. */
    public static final int KEYCODE_YECON_PLAY              = 239;
    /** Key code constant: Yecon next key. */
    public static final int KEYCODE_YECON_NEXT              = 240;
    /** Key code constant: Yecon prev key. */
    public static final int KEYCODE_YECON_PREV              = 241;
    /** Key code constant: Yecon blackout key. */
    public static final int KEYCODE_YECON_BLACKOUT          = 242;
    /** Key code constant: Yecon backlight day key. */
    public static final int KEYCODE_YECON_BACKLIGHT_DAY     = 243;
    /** Key code constant: Yecon backlight off key. */
    public static final int KEYCODE_YECON_BACKLIGHT_OFF     = 244;
    /** Key code constant: Yecon backlight night key. */
    public static final int KEYCODE_YECON_BACKLIGHT_NIGHT   = 245;
    /** Key code constant: Yecon fastf key. */
    public static final int KEYCODE_YECON_FASTF             = 246;
    /** Key code constant: Yecon fastb key. */
    public static final int KEYCODE_YECON_FASTB             = 247;
    /** Key code constant: Yecon power key. */
    public static final int KEYCODE_YECON_POWER             = 248;
    /** Key code constant: Yecon touch scr key. */
    public static final int KEYCODE_YECON_TOUCH_SCR         = 249;
    /** Key code constant: Yecon radio fm key. */
    public static final int KEYCODE_YECON_RADIO_FM          = 250;
    /** Key code constant: Yecon radio am key. */
    public static final int KEYCODE_YECON_RADIO_AM          = 251;
    /** Key code constant: Yecon set eq freq key. */
    public static final int KEYCODE_YECON_SET_EQ            = 252;
    /** Key code constant: Yecon loudness freq key. */
    public static final int KEYCODE_YECON_LOUDNESS          = 253;
    /** Key code constant: Yecon enter freq key. */
    public static final int KEYCODE_YECON_ENTER             = 254;
    /** Key code constant: Yecon radio as freq key. */
    public static final int KEYCODE_YECON_RADIO_AS          = 255;
    /** Key code constant: Yecon tel key. */
    public static final int KEYCODE_YECON_TEL               = 256;
    /** Key code constant: Yecon voice key. */
    public static final int KEYCODE_YECON_VOICE             = 257;
    /** Key code constant: Yecon radio ps key. */
    public static final int KEYCODE_YECON_RADIO_PS          = 258;
    /** Key code constant: Yecon qb power key. */
    public static final int KEYCODE_YECON_QB_POWER          = 259;
    /** Key code constant: Yecon isssr key. */
    public static final int KEYCODE_YECON_ISSSR             = 260;

    private static final int LAST_KEYCODE           = KEYCODE_YECON_ISSSR;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_YECON_EQ, "KEYCODE_YECON_EQ");
        names.append(KEYCODE_YECON_PHONE_ON, "KEYCODE_YECON_PHONE_ON");
        names.append(KEYCODE_YECON_PHONE_OFF, "KEYCODE_YECON_PHONE_OFF");
        names.append(KEYCODE_YECON_SOURCE_MODE, "KEYCODE_YECON_SOURCE_MODE");
        names.append(KEYCODE_YECON_HOME_FRONTSRC, "KEYCODE_YECON_HOME_FRONTSRC");
        names.append(KEYCODE_YECON_DVD_EJECT, "KEYCODE_YECON_DVD_EJECT");
        names.append(KEYCODE_YECON_DVD_CLOSE, "KEYCODE_YECON_DVD_CLOSE");
        names.append(KEYCODE_YECON_MUSIC, "KEYCODE_YECON_MUSIC");
        names.append(KEYCODE_YECON_PHOTO, "KEYCODE_YECON_PHOTO");
        names.append(KEYCODE_YECON_VIDEO, "KEYCODE_YECON_VIDEO");
        names.append(KEYCODE_YECON_NAVI, "KEYCODE_YECON_NAVI");
        names.append(KEYCODE_YECON_TUNER, "KEYCODE_YECON_TUNER");
        names.append(KEYCODE_YECON_DVD, "KEYCODE_YECON_DVD");
        names.append(KEYCODE_YECON_BLUETOOTH, "KEYCODE_YECON_BLUETOOTH");
        names.append(KEYCODE_YECON_SETTING, "KEYCODE_YECON_SETTING");
        names.append(KEYCODE_YECON_TV, "KEYCODE_YECON_TV");
        names.append(KEYCODE_YECON_USB, "KEYCODE_YECON_USB");
        names.append(KEYCODE_YECON_SD_CARD, "KEYCODE_YECON_SD_CARD");
        names.append(KEYCODE_YECON_TOUCH_MENU, "KEYCODE_YECON_TOUCH_MENU");
        names.append(KEYCODE_YECON_PLAY, "KEYCODE_YECON_PLAY");
        names.append(KEYCODE_YECON_NEXT, "KEYCODE_YECON_NEXT");
        names.append(KEYCODE_YECON_PREV, "KEYCODE_YECON_PREV");
        names.append(KEYCODE_YECON_BLACKOUT, "KEYCODE_YECON_BLACKOUT");
        names.append(KEYCODE_YECON_BACKLIGHT_DAY, "KEYCODE_YECON_BACKLIGHT_DAY");
        names.append(KEYCODE_YECON_BACKLIGHT_OFF, "KEYCODE_YECON_BACKLIGHT_OFF");
        names.append(KEYCODE_YECON_BACKLIGHT_NIGHT, "KEYCODE_YECON_BACKLIGHT_NIGHT");
        names.append(KEYCODE_YECON_FASTF, "KEYCODE_YECON_FASTF");
        names.append(KEYCODE_YECON_FASTB, "KEYCODE_YECON_FASTB");
        names.append(KEYCODE_YECON_POWER, "KEYCODE_YECON_POWER");
        names.append(KEYCODE_YECON_TOUCH_SCR, "KEYCODE_YECON_TOUCH_SCR");
        names.append(KEYCODE_YECON_RADIO_FM, "KEYCODE_YECON_RADIO_FM");
        names.append(KEYCODE_YECON_RADIO_AM, "KEYCODE_YECON_RADIO_AM");
        names.append(KEYCODE_YECON_SET_EQ, "KEYCODE_YECON_SET_EQ");
        names.append(KEYCODE_YECON_LOUDNESS, "KEYCODE_YECON_LOUDNESS");
        names.append(KEYCODE_YECON_ENTER, "KEYCODE_YECON_ENTER");
        names.append(KEYCODE_YECON_RADIO_AS, "KEYCODE_YECON_RADIO_AS");
        names.append(KEYCODE_YECON_TEL, "KEYCODE_YECON_TEL");
        names.append(KEYCODE_YECON_VOICE, "KEYCODE_YECON_VOICE");
        names.append(KEYCODE_YECON_RADIO_PS, "KEYCODE_YECON_RADIO_PS");
        names.append(KEYCODE_YECON_QB_POWER, "KEYCODE_YECON_QB_POWER");
        names.append(KEYCODE_YECON_ISSSR, "KEYCODE_YECON_ISSSR");
    };
